...
Ext.define('CustomApp', {
    ...
    showLegend: function () {
      ...
      if (!this.legendDlg) {
        ...
        _.forOwn({ 'Not Scheduled': 'grey', 'Scheduled in Future Iteration': 'yellow', 'Scheduled in Current Iteration': 'green', 'Not Completed in Past Iteration': 'red' }, function (color, label) {
